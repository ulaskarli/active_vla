...
class GDict:
    ...
    def _do_on_list_of_array(cls, memories, function, **kwargs):
        ...
        # print("HERE do on list before if ULAS")
        if isinstance(memories[0], (tuple, list)):
            # print("HERE do on list before tuple,lst ULAS")
            for i in range(len(memories)):
            ...
            # print("HERE do on list tuple,lst ULAS")
        elif isinstance(memories[0], dict):
            # print("HERE do on list before dict ULAS")
            for i in range(len(memories)):
            ...
            for key in memories[0]:
                ret[key] = cls._do_on_list_of_array([memories[j][key] for j in range(len(memories))], function,
                                                    **kwargs)
            # print("HERE do on list dict ULAS")
        else:
            # print("HERE do on list before function ULAS")
            # print(function)
            ret = function(memories, **kwargs)
            # print("HERE do on list function ULAS")
        return ret
    ...
    def stack(cls, items, axis=0, wrapper=True):
        # print("Here Ulas classmethod stack")
